  ...
  head: () => ({
    meta: [
      ...
      { title: "Ghandi Home Electro — Électroménager à Casablanca" },
      {
        name: "description",
        content:
          "Téléviseurs, réfrigérateurs, climatiseurs et machines à laver au 41 Boulevard Ghandi, Casablanca.",
      },
      { name: "author", content: "Ghandi Home Electro" },
      { property: "og:title", content: "Ghandi Home Electro" },
      {
        property: "og:description",
        content: "Électroménager de confiance à Casablanca — Ghandi Home Electro.",
      },
